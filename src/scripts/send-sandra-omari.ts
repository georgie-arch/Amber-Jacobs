...
const bodyText = `Hi Sandra,

Thank you so much for reaching out - really appreciate it.

We would absolutely love to collaborate with Windrush. The work you are doing is exactly the kind of thing that aligns with what we are building at Indvstry Clvb and we think there is a really exciting opportunity for us to do something meaningful together.

Let us get something in the diary to talk through ideas properly. You can grab a time that works for you here:
...
async function main() {
  ...
  const message: any = {
    subject: 'Re: Collaboration with Windrush',
    body: { contentType: 'HTML', content: buildHtml(bodyText) },
    toRecipients: [
      { emailAddress: { address: 'djsandraomari@gmail.com', name: 'Sandra' } },
    ],
    from: {
      emailAddress: {
  ...
  console.log('✅ Sent to Sandra Omari <djsandraomari@gmail.com>');
}
